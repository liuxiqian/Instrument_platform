...
/**
 * @ngdoc function
 * @name webappApp.controller:BusinessTechnologyIndexCtrl
 * @description
 * # BusinessTechnologyIndexCtrl
 * Controller of the webappApp
 */
angular.module('webappApp')
    .controller('BusinessTechnologyIndexCtrl', ['$scope', '$location', 'configService', function($scope, $location, configService) {
        //状态
        $('#businessTechnologyIndexStatus').combobox({
            data: [{
                "id": 1,
                "purpose": "搁置",
                "selected": true
        ...
        configService.getDataGridConfig(function(datagridConfig) {
            ...
            $scope.datagridConfig.toolbar.push({
                ...
                handler: function() {
                    ...
                    $location.path('business/Technology/Add');
                    $scope.$apply();
                }
            });
        ...
        $('#businessTechnologyIndexTable').datagrid($scope.datagridConfig);
